...
As a product evaluator, I need the first release to stay narrow so the graph interaction model can be judged clearly.

## Topic

The current release excludes workflows that distract from graph review.
...
- Missing deterministic replay does not block Phase 1 acceptance.
- Missing collaboration features do not block Phase 1 acceptance.
- Missing mobile layout does not block Phase 1 acceptance.
